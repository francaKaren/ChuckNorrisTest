...
Feature: Consulta de piadas por categoria na API do Chuck Norris
  ...
  Scenario: Validar que a API retorna status 200 para uma categoria válida
    Given que realizo a consulta de piada para a categoria "animal"
  ...
  Scenario: Validar estrutura da resposta da piada
    Given que realizo a consulta de piada para a categoria "animal"
    Then a resposta deve conter os campos "id", "value", "categories"
    And o tempo de resposta da piada deve ser menor que 2000 milissegundos
